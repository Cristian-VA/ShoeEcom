...
const ProductCardCart = ({
  ...
  return (
    <div className="flex gap-4 border-b-[1.5px] py-6 md:py-8 border-gray-600 border-opacity-55 ">
      <img
        src={newItem.image}
        alt={newItem.productName}
        className="object-cover w-[40%] md:w-[32%]"
      />

      <div className="flex flex-col justify-between gap-[2px] w-full">
        ...
        <div className="flex w-full justify-between">
          <div className="border-2 border-gray-400 border-opacity-55 flex   justify-around text-[16px] font-medium">
            <Button
